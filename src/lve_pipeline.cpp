...
namespace lve {
    ...
    void LvePipeline::createGraphicsPipeline(const std::string &vertFilePath,
        ...
        std::vector<VkVertexInputBindingDescription> bindingDescriptions = LveModel::Vertex::getBindingDescriptions();
        std::vector<VkVertexInputAttributeDescription> attributeDescriptions = LveModel::Vertex::getAttributeDescriptions();
        ...
        if (vkCreateGraphicsPipelines(lveDevice.device(), nullptr, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
